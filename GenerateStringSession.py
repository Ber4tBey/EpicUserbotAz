...
class InteractiveTelegramClient(TelegramClient):
    def __init__(self, session_user_id, api_id, api_hash,
        ...
        self.found_media = {}
        print('@EpicUserBot String Alıcıya Xoş Gəldiniz')
        ...
        if not loop.run_until_complete(self.is_user_authorized()):
            ...
            while self_user is None:
                ...
                try:
                    ...
                    print("[!]Kodu səhv yazdınız. Yenidən yoxlayın. [Fazla Deneme Yapmak Ban Yemenize Neden Olur]")
                    ...
                    try:
                        ...
                        print("[!] 2 faktorlu şifrəni səhv yazdınız. Yenidən yoxlayın. [Fazla Deneme Yapmak Ban Yemenize Neden Olur]")
...
if __name__ == '__main__':
   ...
   if secim == 2:
      ...
      if soup.title.string == "Create new application":
         ...
         app_id = g_inputs[0].string
         api_hash = g_inputs[1].string
         print("[i] BMəlumatlar gətirildi! Xahiş edirəm bunları qeyd edin.\n\n")
         print(f"[i] API ID: {app_id}")
         print(f"[i] API HASH: {api_hash}")
         try:
            stringonay = int(input("[?] String almaq istəyirsən? [Almaq üçün 1 yaz]: "))
